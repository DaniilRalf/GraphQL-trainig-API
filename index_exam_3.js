...
/**
 * В этой конфигурации рассматривается связь один ко многим
 * Для этого внедрим еще одну сущбность User
 * User имеет некоторое кол-во Photo
 * Добавим данные для наглядности
 * */
...
/**
 * githubUser - поле показыающее связь photos и users
 * Нет необходимости добавлять в Схему, поскольку на практике его нет необходимости передавать на клиент
 * */
let photos = [
